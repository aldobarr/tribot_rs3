...
public class DTMHandler{
	...
	//Skills
	private static DTM attackSkillDTM;
	private static DTM strengthSkillDTM;
	private static DTM defenceSkillDTM;
	private static DTM rangedSkillDTM;
	private static DTM prayerSkillDTM;
	private static DTM magicSkillDTM;
	private static DTM runecraftingSkillDTM;
	private static DTM constructionSkillDTM;
	private static DTM dungeoneeringSkillDTM;
	private static DTM hpSkillDTM;
	private static DTM agilitySkillDTM;
	private static DTM herbloreSkillDTM;
	private static DTM thievingSkillDTM;
	private static DTM craftingSkillDTM;
	private static DTM fletchingSkillDTM;
	private static DTM slayerSkillDTM;
	private static DTM hunterSkillDTM;
	private static DTM divinationSkillDTM;
	private static DTM miningSkillDTM;
	private static DTM smithingSkillDTM;
	private static DTM fishingSkillDTM;
	private static DTM cookingSkillDTM;
	private static DTM firemakingSkillDTM;
	private static DTM woodcuttingSkillDTM;
	private static DTM farmingSkillDTM;
	private static DTM summoningSkillDTM;
	//end skills
	...
	// 54x22
	public static DTM getAttackSkillDTM(){
		if(attackSkillDTM != null)
			return attackSkillDTM;
		DTMPoint point = new DTMPoint(new Color(32, 32, 29), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(18, 0), new Color(247, 246, 241)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 11), new Color(229, 204, 108)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(0, 19), new Color(124, 101, 48)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 17), new Color(84, 58, 24)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 16), new Color(2, 1, 2)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 13), new Color(249, 235, 94)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 10), new Color(253, 250, 215)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 5), new Color(229, 229, 209)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 3), new Color(67, 68, 70)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 1), new Color(125, 130, 129)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 7), new Color(193, 197, 195)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 9), new Color(4, 4, 5)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 10), new Color(29, 40, 45)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 13), new Color(13, 21, 25)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 17), new Color(37, 30, 20)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 6), new Color(33, 38, 41)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 3), new Color(49, 54, 57)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 19), new Color(11, 17, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 16), new Color(21, 32, 37)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 18), new Color(13, 21, 25)), new Tolerance(10, 10, 10), 1)};
		attackSkillDTM = new DTM(point, points);
		return attackSkillDTM;
	}
	
	// 54x22
	public static DTM getStrengthSkillDTM(){
		if(strengthSkillDTM != null)
			return strengthSkillDTM;
		DTMPoint point = new DTMPoint(new Color(32, 32, 29), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(2, 1), new Color(201, 155, 146)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 9), new Color(230, 162, 116)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 6), new Color(221, 140, 93)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 2), new Color(191, 117, 88)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 10), new Color(199, 116, 68)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 6), new Color(2, 1, 2)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 6), new Color(253, 233, 180)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, -1), new Color(239, 168, 120)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 0), new Color(244, 184, 149)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 4), new Color(166, 132, 96)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 8), new Color(247, 246, 241)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 6), new Color(191, 117, 88)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 12), new Color(22, 3, 4)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 13), new Color(247, 212, 182)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 17), new Color(194, 155, 146)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 15), new Color(194, 141, 95)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 8), new Color(106, 103, 143)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 4), new Color(183, 112, 67)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 6), new Color(61, 59, 56)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 11), new Color(122, 35, 35)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 14), new Color(107, 127, 148)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 15), new Color(149, 105, 54)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 19), new Color(121, 43, 56)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 18), new Color(138, 95, 73)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 16), new Color(21, 32, 37)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 17), new Color(5, 10, 13)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 15), new Color(11, 17, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 1), new Color(58, 65, 68)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(20, 6), new Color(45, 56, 61)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(20, 12), new Color(29, 40, 45)), new Tolerance(10, 10, 10), 1)};
		strengthSkillDTM = new DTM(point, points);
		return strengthSkillDTM;
	}
	
	// 54x22
	public static DTM getDefenceSkillDTM(){
		if(defenceSkillDTM != null)
			return defenceSkillDTM;
		DTMPoint point = new DTMPoint(new Color(32, 32, 29), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(8, 8), new Color(154, 157, 155)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 2), new Color(174, 181, 185)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 1), new Color(251, 254, 254)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, -1), new Color(197, 191, 167)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, -1), new Color(183, 165, 78)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 1), new Color(197, 183, 154)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 1), new Color(42, 47, 50)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 9), new Color(113, 104, 93)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 6), new Color(78, 73, 62)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 15), new Color(105, 94, 73)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 18), new Color(105, 94, 73)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 20), new Color(126, 121, 96)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 17), new Color(121, 125, 124)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 11), new Color(145, 143, 125)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(0, 6), new Color(89, 89, 77)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 5), new Color(134, 137, 139)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 8), new Color(189, 206, 215)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 14), new Color(133, 130, 128)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 8), new Color(251, 254, 254)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 5), new Color(134, 137, 139)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 12), new Color(79, 92, 101)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 14), new Color(133, 130, 128)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 16), new Color(108, 108, 110)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 4), new Color(133, 130, 128)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 8), new Color(251, 254, 254)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(20, 5), new Color(43, 54, 59)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 13), new Color(26, 36, 42)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 18), new Color(13, 21, 25)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(23, 15), new Color(26, 36, 42)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(23, 10), new Color(29, 43, 50)), new Tolerance(10, 10, 10), 1)};
		defenceSkillDTM = new DTM(point, points);
		return defenceSkillDTM;
	}
	
	// 54x22
	public static DTM getRangedSkillDTM(){
		if(rangedSkillDTM != null)
			return rangedSkillDTM;
		DTMPoint point = new DTMPoint(new Color(80, 65, 51), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(1, 2), new Color(170, 168, 147)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 5), new Color(169, 170, 168)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 8), new Color(153, 156, 154)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 10), new Color(134, 137, 139)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 13), new Color(145, 143, 125)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 16), new Color(145, 143, 125)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 19), new Color(113, 104, 93)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 15), new Color(145, 74, 14)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 12), new Color(145, 74, 14)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 9), new Color(191, 139, 94)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 6), new Color(76, 76, 77)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 4), new Color(96, 97, 98)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 2), new Color(52, 25, 23)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 1), new Color(103, 33, 7)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 0), new Color(60, 21, 6)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 12), new Color(46, 34, 26)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 15), new Color(22, 3, 4)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 17), new Color(59, 252, 81)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 15), new Color(40, 89, 45)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 3), new Color(189, 206, 215)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 5), new Color(28, 27, 24)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 4), new Color(6, 7, 8)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 13), new Color(19, 29, 34)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 11), new Color(21, 32, 37)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 6), new Color(33, 38, 41)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 3), new Color(50, 51, 51)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 6), new Color(43, 53, 57)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(21, 17), new Color(26, 33, 37)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 17), new Color(11, 17, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 15), new Color(13, 21, 25)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 9), new Color(18, 25, 29)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 10), new Color(11, 17, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 18), new Color(6, 13, 16)), new Tolerance(10, 10, 10), 1)};
		rangedSkillDTM = new DTM(point, points);
		return rangedSkillDTM;
	}
	...
	// 54x22
	public static DTM getRunecraftingSkillDTM(){
		if(runecraftingSkillDTM != null)
			return runecraftingSkillDTM;
		DTMPoint point = new DTMPoint(new Color(153, 53, 38), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(1, 7), new Color(214, 163, 98)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 4), new Color(244, 242, 147)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 6), new Color(249, 248, 199)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 8), new Color(249, 248, 199)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 11), new Color(249, 248, 199)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 13), new Color(243, 222, 140)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 16), new Color(236, 109, 74)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 18), new Color(229, 90, 64)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 19), new Color(104, 46, 39)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 5), new Color(241, 172, 146)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 6), new Color(241, 172, 146)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 1), new Color(229, 90, 64)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 4), new Color(252, 250, 237)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 3), new Color(250, 245, 211)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 11), new Color(250, 245, 224)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 12), new Color(207, 192, 180)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 16), new Color(87, 60, 36)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 16), new Color(36, 28, 18)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 15), new Color(150, 139, 131)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 7), new Color(229, 202, 177)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 9), new Color(161, 154, 141)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 9), new Color(237, 181, 95)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 2), new Color(111, 79, 50)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 10), new Color(49, 36, 35)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 4), new Color(48, 53, 56)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 14), new Color(26, 36, 42)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 18), new Color(11, 17, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 17), new Color(5, 10, 13)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 18), new Color(4, 7, 10)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 6), new Color(43, 53, 57)), new Tolerance(10, 10, 10), 1)};
		runecraftingSkillDTM = new DTM(point, points);
		return runecraftingSkillDTM;
	}
	
	// 54x22
	public static DTM getConstructionSkillDTM(){
		if(constructionSkillDTM != null)
			return constructionSkillDTM;
		DTMPoint point = new DTMPoint(new Color(32, 32, 29), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(-2, 7), new Color(149, 127, 106)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(-3, 13), new Color(149, 148, 148)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(-1, 15), new Color(254, 254, 254)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 16), new Color(28, 28, 27)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 13), new Color(108, 102, 97)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 12), new Color(37, 20, 10)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 10), new Color(209, 144, 70)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 8), new Color(252, 250, 237)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 6), new Color(179, 178, 177)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 6), new Color(85, 54, 19)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 4), new Color(102, 58, 20)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 0), new Color(154, 108, 53)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 0), new Color(165, 147, 127)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 3), new Color(0, 0, 1)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 2), new Color(129, 93, 55)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 4), new Color(165, 147, 127)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 6), new Color(91, 91, 91)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 9), new Color(153, 156, 159)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(0, 10), new Color(91, 91, 91)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 8), new Color(109, 76, 27)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 6), new Color(107, 96, 78)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 15), new Color(62, 43, 40)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 18), new Color(92, 67, 55)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 15), new Color(183, 141, 91)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 12), new Color(174, 146, 109)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 10), new Color(166, 118, 76)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 12), new Color(236, 175, 66)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 17), new Color(238, 208, 86)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 18), new Color(193, 123, 60)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 19), new Color(209, 144, 70)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 14), new Color(214, 163, 98)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 16), new Color(241, 208, 121)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 13), new Color(216, 186, 144)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 8), new Color(31, 41, 46)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 6), new Color(43, 53, 57)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 9), new Color(34, 45, 50)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(20, 15), new Color(26, 36, 42)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 19), new Color(11, 17, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 2), new Color(49, 54, 57)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 3), new Color(43, 49, 52)), new Tolerance(10, 10, 10), 1)};
		constructionSkillDTM = new DTM(point, points);
		return constructionSkillDTM;
	}
	
	// 54x22
	public static DTM getDungeoneeringSkillDTM(){
		if(dungeoneeringSkillDTM != null)
			return dungeoneeringSkillDTM;
		DTMPoint point = new DTMPoint(new Color(30, 30, 27), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(3, 1), new Color(56, 14, 10)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 1), new Color(135, 40, 20)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 1), new Color(239, 161, 113)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 1), new Color(147, 55, 42)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 2), new Color(108, 102, 97)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 2), new Color(252, 250, 237)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 4), new Color(161, 154, 141)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 7), new Color(115, 62, 49)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 10), new Color(91, 18, 10)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 14), new Color(229, 90, 64)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 17), new Color(91, 18, 10)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 19), new Color(154, 108, 53)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 19), new Color(109, 76, 27)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 19), new Color(73, 51, 14)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 17), new Color(133, 88, 31)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 14), new Color(165, 137, 79)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 15), new Color(245, 226, 171)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 12), new Color(185, 141, 82)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(-1, 9), new Color(109, 76, 27)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(0, 5), new Color(250, 245, 211)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 3), new Color(237, 137, 79)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 7), new Color(220, 34, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 5), new Color(220, 34, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 5), new Color(208, 32, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 3), new Color(241, 172, 146)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 5), new Color(128, 117, 103)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 10), new Color(250, 245, 211)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 14), new Color(244, 242, 147)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 16), new Color(254, 254, 254)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 13), new Color(154, 108, 53)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 13), new Color(0, 0, 1)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 9), new Color(0, 0, 1)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 15), new Color(236, 131, 126)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(20, 1), new Color(56, 64, 67)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(21, 5), new Color(49, 58, 61)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(21, 14), new Color(26, 36, 40)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 19), new Color(18, 28, 32)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 19), new Color(10, 15, 19)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 17), new Color(10, 15, 18)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(21, 10), new Color(31, 41, 46)), new Tolerance(10, 10, 10), 1)};
		dungeoneeringSkillDTM = new DTM(point, points);
		return dungeoneeringSkillDTM;
	}
	
	// 54x22
	public static DTM getHPSkillDTM(){
		if(hpSkillDTM != null)
			return hpSkillDTM;
		DTMPoint point = new DTMPoint(new Color(97, 37, 27), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(2, -1), new Color(118, 34, 34)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, -1), new Color(119, 42, 55)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 1), new Color(228, 141, 143)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 3), new Color(251, 83, 86)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 1), new Color(228, 141, 143)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, -1), new Color(119, 43, 55)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, -1), new Color(95, 36, 26)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 0), new Color(80, 50, 41)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 3), new Color(145, 13, 11)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 7), new Color(145, 13, 11)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 10), new Color(146, 13, 11)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 12), new Color(122, 13, 10)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 14), new Color(181, 12, 8)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 17), new Color(122, 13, 10)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 19), new Color(236, 182, 183)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 17), new Color(146, 38, 35)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 15), new Color(146, 13, 11)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 12), new Color(122, 13, 10)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(0, 9), new Color(146, 13, 11)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(-1, 5), new Color(146, 13, 11)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(-1, 2), new Color(121, 35, 35)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 4), new Color(236, 182, 183)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 4), new Color(217, 166, 156)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 5), new Color(251, 254, 254)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 5), new Color(226, 215, 214)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 11), new Color(246, 21, 20)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 12), new Color(181, 12, 8)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 10), new Color(175, 22, 22)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 13), new Color(213, 33, 29)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 16), new Color(5, 10, 13)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 17), new Color(13, 21, 25)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(22, 6), new Color(45, 56, 61)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 13), new Color(26, 36, 42)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 18), new Color(5, 10, 13)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(20, 0), new Color(97, 102, 98)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 1), new Color(6, 6, 7)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 15), new Color(237, 49, 50)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 6), new Color(199, 135, 123)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 9), new Color(122, 35, 35)), new Tolerance(10, 10, 10), 1)};
		hpSkillDTM = new DTM(point, points);
		return hpSkillDTM;
	}
	
	// 54x22
	public static DTM getAgilitySkillDTM(){
		if(agilitySkillDTM != null)
			return agilitySkillDTM;
		DTMPoint point = new DTMPoint(new Color(32, 32, 29), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(9, -1), new Color(214, 191, 102)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, -1), new Color(170, 110, 33)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 3), new Color(221, 171, 65)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 1), new Color(20, 25, 18)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 2), new Color(221, 171, 65)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 4), new Color(89, 55, 25)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 6), new Color(177, 88, 13)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 6), new Color(177, 88, 13)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 7), new Color(4, 4, 12)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 9), new Color(19, 26, 30)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 2), new Color(242, 174, 87)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 2), new Color(221, 171, 65)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 3), new Color(146, 120, 60)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 6), new Color(147, 77, 34)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 5), new Color(6, 6, 7)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 8), new Color(20, 25, 28)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 8), new Color(147, 77, 34)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 6), new Color(225, 176, 30)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 8), new Color(225, 176, 30)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 11), new Color(197, 142, 61)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 14), new Color(173, 113, 34)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 17), new Color(177, 115, 34)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 17), new Color(98, 60, 34)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 19), new Color(75, 54, 33)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 14), new Color(192, 176, 108)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 12), new Color(183, 165, 78)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 14), new Color(200, 120, 25)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 16), new Color(135, 71, 33)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 18), new Color(73, 54, 37)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(0, 18), new Color(168, 110, 35)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 15), new Color(232, 214, 63)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 12), new Color(148, 104, 54)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 10), new Color(200, 144, 61)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 11), new Color(229, 204, 108)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 4), new Color(145, 93, 27)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 11), new Color(10, 16, 20)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 13), new Color(5, 9, 12)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 15), new Color(11, 18, 22)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 18), new Color(5, 10, 13)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 18), new Color(11, 17, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 18), new Color(8, 13, 17)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 11), new Color(26, 36, 42)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 7), new Color(36, 48, 54)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 14), new Color(25, 32, 36)), new Tolerance(10, 10, 10), 1)};
		agilitySkillDTM = new DTM(point, points);
		return agilitySkillDTM;
	}
	
	// 54x22
	public static DTM getHerbloreSkillDTM(){
		if(herbloreSkillDTM != null)
			return herbloreSkillDTM;
		DTMPoint point = new DTMPoint(new Color(32, 32, 29), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(-2, 9), new Color(167, 212, 75)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(-1, 13), new Color(162, 190, 71)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 16), new Color(232, 214, 63)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 18), new Color(83, 111, 48)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 19), new Color(84, 105, 20)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 19), new Color(14, 19, 10)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 18), new Color(60, 110, 132)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 16), new Color(32, 62, 111)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 13), new Color(23, 48, 106)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 8), new Color(165, 193, 72)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 10), new Color(147, 140, 85)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 5), new Color(46, 60, 57)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 6), new Color(57, 57, 23)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 4), new Color(60, 110, 106)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 1), new Color(29, 55, 82)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(8, 0), new Color(136, 163, 56)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 2), new Color(82, 127, 75)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 5), new Color(115, 162, 44)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 6), new Color(137, 189, 79)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 5), new Color(50, 85, 42)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 8), new Color(83, 129, 76)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 11), new Color(59, 116, 79)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(0, 8), new Color(16, 25, 37)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 7), new Color(37, 93, 40)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 10), new Color(37, 93, 40)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 10), new Color(117, 190, 38)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 14), new Color(37, 93, 40)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 16), new Color(54, 83, 90)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 3), new Color(43, 49, 52)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(0, 5), new Color(83, 84, 75)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 2), new Color(51, 58, 61)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(21, 11), new Color(29, 43, 50)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 17), new Color(19, 28, 33)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 3), new Color(51, 58, 61)), new Tolerance(10, 10, 10), 1)};
		herbloreSkillDTM = new DTM(point, points);
		return herbloreSkillDTM;
	}
	
	// 54x22
	public static DTM getThievingSkillDTM(){
		if(thievingSkillDTM != null)
			return thievingSkillDTM;
		DTMPoint point = new DTMPoint(new Color(32, 32, 29), new Tolerance(10, 10, 10));
		DTMSubPoint points[] = {new DTMSubPoint(new ColourPoint(new Point(-1, 5), new Color(184, 184, 182)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(-1, 9), new Color(116, 95, 45)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 12), new Color(58, 60, 61)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(4, 13), new Color(59, 61, 63)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 14), new Color(56, 55, 53)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 15), new Color(33, 37, 39)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(11, 15), new Color(75, 71, 61)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 13), new Color(96, 97, 98)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 13), new Color(57, 56, 54)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 12), new Color(62, 65, 66)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 10), new Color(42, 55, 67)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 8), new Color(28, 27, 24)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 6), new Color(251, 254, 254)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(19, 4), new Color(40, 48, 48)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(17, 3), new Color(24, 26, 27)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 3), new Color(20, 21, 21)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 3), new Color(5, 4, 5)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 3), new Color(32, 33, 31)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 4), new Color(247, 246, 241)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(1, 6), new Color(191, 191, 189)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(3, 8), new Color(2, 1, 2)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 8), new Color(7, 8, 10)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 12), new Color(2, 1, 2)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(9, 9), new Color(226, 215, 214)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(7, 11), new Color(28, 28, 38)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(13, 11), new Color(2, 1, 2)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 6), new Color(61, 59, 56)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(16, 5), new Color(133, 130, 128)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 6), new Color(67, 68, 70)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(15, 10), new Color(121, 125, 124)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(6, 5), new Color(134, 137, 139)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(12, 1), new Color(56, 63, 66)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(20, 3), new Color(52, 61, 65)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(20, 8), new Color(34, 46, 52)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(18, 13), new Color(26, 36, 42)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(14, 14), new Color(17, 26, 30)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(10, 16), new Color(11, 16, 18)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(5, 15), new Color(11, 11, 12)), new Tolerance(10, 10, 10), 1), new DTMSubPoint(new ColourPoint(new Point(2, 14), new Color(6, 13, 16)), new Tolerance(10, 10, 10), 1)};
		thievingSkillDTM = new DTM(point, points);
		return thievingSkillDTM;
	}
	...
	public static DTM getSkillDTM(Skills.SKILLS skill){
		switch(skill){
			...
			case STRENGTH:
				return getStrengthSkillDTM();
			case DEFENCE:
				return getDefenceSkillDTM();
			case RANGED:
				return getRangedSkillDTM();
			case PRAYER:
				return getPrayerSkillDTM();
			case MAGIC:
				return getMagicSkillDTM();
			case RUNECRAFTING:
				return getRunecraftingSkillDTM();
			case CONSTRUCTION:
				return getConstructionSkillDTM();
			case DUNGEONEERING:
				return getDungeoneeringSkillDTM();
			case HITPOINTS:
				return getHPSkillDTM();
			case AGILITY:
				return getAgilitySkillDTM();
			case HERBLORE:
				return getHerbloreSkillDTM();
			case THIEVING:
				return getThievingSkillDTM();
			case CRAFTING:
			case FLETCHING:
			case SLAYER:
			case HUNTER:
