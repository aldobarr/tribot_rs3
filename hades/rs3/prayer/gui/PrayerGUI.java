package hades.rs3.prayer.gui;

import hades.rs3.prayer.Prayer;
...
public class PrayerGUI extends JFrame{
	 ...
	 * Create the frame.
	 */
	public PrayerGUI(Prayer prayer, WindowListener wl){
		setResizable(false);
		...
		separator.setBounds(279, 7, 2, 120);
		...
		btnStart.setBounds(528, 127, 97, 25);
		contentPane.add(btnStart);
		btnStart.addActionListener(new StartPressed(prayer, this));
